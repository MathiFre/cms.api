...
namespace CMS.infraestructure.Repositories.Security
{
    public class RoleRepository : IRoleRepository
    {
        ...
        public RoleRepository(CmsContext context, RoleManager<IdentityRole<Guid>> roleManager, UserManager<IdentityUser<Guid>> userManager)
        {
            _context = context;
